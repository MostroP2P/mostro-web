  ...
  <div style="width: 100%">
    <v-list-item-content>
      ...
      <div class="wrap-text text-message">
        🕐 <npub :npub="sellerPubkey"/> already released the satoshis, expect your invoice to be paid any time, remember your wallet needs to be online to receive through lighntning network.
      </div>
    </v-list-item-content>
  </div>
</template>
