...
#### [0.0.23](https://github.com/MostroP2P/mostro-web/compare/0.0.23...0.0.23)
...
- fix: removes v-chip component from the chat, allowing multiple lines to be displayed [`4d63403`](https://github.com/MostroP2P/mostro-web/commit/4d63403cbc36baf5ef0aeb901e20d3620a4366fe)
- chore: updates changelog [`3b6d78f`](https://github.com/MostroP2P/mostro-web/commit/3b6d78fec29ab13654207ca1d9391d90e7e94534)
- feat: removes mostro's npub from thread summaries [`0f69e0b`](https://github.com/MostroP2P/mostro-web/commit/0f69e0b42ffcb10553295a01050d3939e47edb09)
- style: adjusts time message's alignment [`2d970f9`](https://github.com/MostroP2P/mostro-web/commit/2d970f916c13384ec5660d80e6848ed910d4b44d)
- feat: resets the input field before showing the sent message in the chat box [`70300ac`](https://github.com/MostroP2P/mostro-web/commit/70300ac29d6d47a933c0496dcc83a7b28e379810)
- chore: bumps version number [`e94096d`](https://github.com/MostroP2P/mostro-web/commit/e94096d73443d7601f52b6ec679af5f052387ef8)
- style: adjusts chat bubble color [`32d222e`](https://github.com/MostroP2P/mostro-web/commit/32d222e03ee3dba167124a4b21043debbf8b05b2)
...
- refactor: introduces more focused components InvoiceAcceptedMessage & PayInvoiceMessage [`3455975`](https://github.com/MostroP2P/mostro-web/commit/34559756d30fc17e931f435201ae3eb4da8f70f8)
- Initial commit [`08b7ab4`](https://github.com/MostroP2P/mostro-web/commit/08b7ab4951025fbb7e73dae3cf6cc3696050884b)
- chore: serving nostr-tools from the same origin [`1c5d6fa`](https://github.com/MostroP2P/mostro-web/commit/1c5d6fa06371b324dfd88d160dbb07d98bfc019f)
- feature: adds country flags next to order currency codes [`27e0609`](https://github.com/MostroP2P/mostro-web/commit/27e06095d5a076f2f67d515ff68ff70f15f6715e)
- feature: introduces web worker to calculate bcrypt hash of the password in a different thread [`bf0858d`](https://github.com/MostroP2P/mostro-web/commit/bf0858d06c2522b4c2fcf7d86286c5c6c170b9e8)
- refactor: removes web workers [`566b530`](https://github.com/MostroP2P/mostro-web/commit/566b5301fdd17ef184e437001732275baf23b411)
- feature: introduces the GiveInvoiceButton for the situation where the buyer (as a maker) didn't provide an invoice of it has expired [`a20eec1`](https://github.com/MostroP2P/mostro-web/commit/a20eec1deb9c23dfae3fc0529e82903defc897ee)
